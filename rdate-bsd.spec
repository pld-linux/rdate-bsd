...
Source0:	ftp://ftp.debian.org/debian/pool/main/r/rdate/rdate_%{version}.orig.tar.gz
...
install -d $RPM_BUILD_ROOT{%{_sbindir},%{_mandir}/man8,%{_sysconfdir}/{rc.d/init.d,sysconfig,cron.daily}}
